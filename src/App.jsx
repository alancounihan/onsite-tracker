...
export default function App() {
  ...
  }, [offSoFar, offPlannedRest, priorCompliancePct, excludedDates, plannedLeave, today]);
        ...
        <div className="max-w-5xl mx-auto px-6 py-6 flex items-baseline justify-between">
          <div>
            <h1 className="text-2xl font-bold tracking-tight">
              Onsite Compliance <span className="text-accent">Predictor</span>
            </h1>
